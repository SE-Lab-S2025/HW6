...
public class SymbolTable {
    ...
    public void addField(String fieldName, String className) {
        klasses.get(className).Fields.put(fieldName, new Symbol(lastType, mem.allocateData()));
    }
...
//        try {
        ...
        klasses.get(className).Methodes.get(methodName).localVariable.put(localVariableName, new Symbol(lastType, mem.allocateData()));
...
//        }
    ...
    class Method {
        ...
        public Method(int codeAddress, SymbolType returnType) {
            ...
            this.returnAddress = mem.allocateData();
            this.callerAddress = mem.allocateData();
        ...
        public void addParameter(String parameterName) {
            parameters.put(parameterName, new Symbol(lastType, mem.allocateData()));
